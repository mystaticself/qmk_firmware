...
// 1, F7, F8, F9, F10, F11, F12, N, W, E, J, I, M, FN (R_ALT)
const int LAYER_1_SIZE = 14;
int layer1LEDs[] = {7, 39, 44, 50, 56, 61, 66, 38, 14, 20, 42, 46, 43, 55};

// J, M, FN (R_ALT), Q, W, E, A, S, D, Z, X, C, DEL, PGUP, PGDN, END
const int LAYER_2_SIZE = 16;
int layer2LEDs[] = {42, 43, 55, 8, 14, 20, 9, 15, 21, 10, 16, 22, 72, 75, 86, 82};
...
qk_tap_dance_action_t tap_dance_actions[] = {
    // Tap once for Page Up, twice for CMD + Up
    [TD_PGUP] = ACTION_TAP_DANCE_DOUBLE(KC_PGUP, LGUI(KC_UP)),
    // Tap once for Page Down, twice for CMD + Down
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, _______, MCRO_02, MCRO_03, _______, _______, _______, _______, MCRO_07, _______, _______, _______, _______, RESET,            _______,
        ...
        _______, _______, _______,                            _______,                            _______, KC_LEAD, _______, _______, _______, _______
    ),

    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RESET,            KC_KP_SLASH,
        _______, KC_KP_1, KC_KP_2, KC_KP_3, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_KP_ASTERISK,
        _______, KC_KP_4, KC_KP_5, KC_KP_6, _______, _______, _______, MCRO_01, _______, _______, _______, _______,          _______,          KC_KP_MINUS,
        _______,          KC_KP_7, KC_KP_8, KC_KP_9, _______, _______, _______, MCRO_05, _______, _______, _______,          _______, _______, KC_KP_PLUS,
        _______, _______, KC_KP_0,                            _______,                            _______, KC_LEAD, _______, _______, _______, _______
    ),
