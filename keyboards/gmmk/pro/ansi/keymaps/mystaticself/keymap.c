...
// 1, F7, F8, F9, F10, F11, F12, N, W, E, J, I, M, COMMA, FN (R_ALT)
const int LAYER_1_SIZE = 15;
int layer1LEDs[] = {7, 39, 44, 50, 56, 61, 66, 38, 14, 20, 42, 46, 43, 48, 55};

// J, M, FN (R_ALT)
const int LAYER_2_SIZE = 3;
int layer2LEDs[] = {42, 43, 55};
